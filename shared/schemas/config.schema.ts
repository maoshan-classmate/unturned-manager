 ...
 *
 * U3-SDK `WorkshopDownloadConfig.cs:30` 用 `List<ulong>`，Unity JsonUtility 把 ulong
 * 序列化为 JSON number（非字符串）；面板 acf 解析走 VDF 文本 `Object.entries` 返回
 * string keys。跨语言类型不对齐是必然，在 schema 层归一。
 */
